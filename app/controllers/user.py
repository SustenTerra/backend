...
from app.exceptions.user import UserAlreadyRegisteredException, UserPasswordDoNotMatchException
...
class UserController(
    ...
    def update_password(self, id, update: UserUpdatePassword):
        ...
        if found_user and not Hasher.verify_password(update.current_password, found_user.password):
